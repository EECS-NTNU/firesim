...
#ifdef TRACEDOCTORBRIDGEMODULE_0_PRESENT
  INSTANTIATE_TRACEDOCTOR(add_bridge_driver, 0)
#endif
#ifdef TRACEDOCTORBRIDGEMODULE_1_PRESENT
  INSTANTIATE_TRACEDOCTOR(add_bridge_driver, 1)
#endif
#ifdef TRACEDOCTORBRIDGEMODULE_2_PRESENT
  INSTANTIATE_TRACEDOCTOR(add_bridge_driver, 2)
#endif
#ifdef TRACEDOCTORBRIDGEMODULE_3_PRESENT
  INSTANTIATE_TRACEDOCTOR(add_bridge_driver, 3)
#endif
#ifdef TRACEDOCTORBRIDGEMODULE_4_PRESENT
  INSTANTIATE_TRACEDOCTOR(add_bridge_driver, 4)
#endif
#ifdef TRACEDOCTORBRIDGEMODULE_5_PRESENT
  INSTANTIATE_TRACEDOCTOR(add_bridge_driver, 5)
#endif
#ifdef TRACEDOCTORBRIDGEMODULE_6_PRESENT
  INSTANTIATE_TRACEDOCTOR(add_bridge_driver, 6)
#endif
#ifdef TRACEDOCTORBRIDGEMODULE_7_PRESENT
  INSTANTIATE_TRACEDOCTOR(add_bridge_driver, 7)
#endif
#ifdef TRACEDOCTORBRIDGEMODULE_8_PRESENT
  INSTANTIATE_TRACEDOCTOR(add_bridge_driver, 8)
#endif
#ifdef TRACEDOCTORBRIDGEMODULE_9_PRESENT
  INSTANTIATE_TRACEDOCTOR(add_bridge_driver, 9)
#endif
#ifdef TRACEDOCTORBRIDGEMODULE_10_PRESENT
  INSTANTIATE_TRACEDOCTOR(add_bridge_driver, 10)
#endif
#ifdef TRACEDOCTORBRIDGEMODULE_11_PRESENT
  INSTANTIATE_TRACEDOCTOR(add_bridge_driver, 11)
#endif
#ifdef TRACEDOCTORBRIDGEMODULE_12_PRESENT
  INSTANTIATE_TRACEDOCTOR(add_bridge_driver, 12)
#endif
#ifdef TRACEDOCTORBRIDGEMODULE_13_PRESENT
  INSTANTIATE_TRACEDOCTOR(add_bridge_driver, 13)
#endif
#ifdef TRACEDOCTORBRIDGEMODULE_14_PRESENT
  INSTANTIATE_TRACEDOCTOR(add_bridge_driver, 14)
#endif
#ifdef TRACEDOCTORBRIDGEMODULE_15_PRESENT
  INSTANTIATE_TRACEDOCTOR(add_bridge_driver, 15)
#endif
#ifdef TRACEDOCTORBRIDGEMODULE_16_PRESENT
  INSTANTIATE_TRACEDOCTOR(add_bridge_driver, 16)
#endif
#ifdef TRACEDOCTORBRIDGEMODULE_17_PRESENT
  INSTANTIATE_TRACEDOCTOR(add_bridge_driver, 17)
#endif
#ifdef TRACEDOCTORBRIDGEMODULE_18_PRESENT
  INSTANTIATE_TRACEDOCTOR(add_bridge_driver, 18)
#endif
#ifdef TRACEDOCTORBRIDGEMODULE_19_PRESENT
  INSTANTIATE_TRACEDOCTOR(add_bridge_driver, 19)
#endif
#ifdef TRACEDOCTORBRIDGEMODULE_20_PRESENT
  INSTANTIATE_TRACEDOCTOR(add_bridge_driver, 20)
#endif
#ifdef TRACEDOCTORBRIDGEMODULE_21_PRESENT
  INSTANTIATE_TRACEDOCTOR(add_bridge_driver, 21)
#endif
#ifdef TRACEDOCTORBRIDGEMODULE_22_PRESENT
  INSTANTIATE_TRACEDOCTOR(add_bridge_driver, 22)
#endif
#ifdef TRACEDOCTORBRIDGEMODULE_23_PRESENT
  INSTANTIATE_TRACEDOCTOR(add_bridge_driver, 23)
#endif
#ifdef TRACEDOCTORBRIDGEMODULE_24_PRESENT
  INSTANTIATE_TRACEDOCTOR(add_bridge_driver, 24)
#endif
#ifdef TRACEDOCTORBRIDGEMODULE_25_PRESENT
  INSTANTIATE_TRACEDOCTOR(add_bridge_driver, 25)
#endif
#ifdef TRACEDOCTORBRIDGEMODULE_26_PRESENT
  INSTANTIATE_TRACEDOCTOR(add_bridge_driver, 26)
#endif
#ifdef TRACEDOCTORBRIDGEMODULE_27_PRESENT
  INSTANTIATE_TRACEDOCTOR(add_bridge_driver, 27)
#endif
#ifdef TRACEDOCTORBRIDGEMODULE_28_PRESENT
  INSTANTIATE_TRACEDOCTOR(add_bridge_driver, 28)
#endif
#ifdef TRACEDOCTORBRIDGEMODULE_29_PRESENT
  INSTANTIATE_TRACEDOCTOR(add_bridge_driver, 29)
#endif
#ifdef TRACEDOCTORBRIDGEMODULE_30_PRESENT
  INSTANTIATE_TRACEDOCTOR(add_bridge_driver, 30)
#endif
#ifdef TRACEDOCTORBRIDGEMODULE_31_PRESENT
  INSTANTIATE_TRACEDOCTOR(add_bridge_driver, 31)
#endif
#endif
